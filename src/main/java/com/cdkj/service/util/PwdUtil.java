/**
 * @Title PwdUtils.java @Package com.hsnet.pz.ao.util @Description
 *
...
public class PwdUtil {
    ...
    /**
     * 密码合法性检测 密码长度6~16位字符，包括英文字符、数字、符号，不支持中文字符
     *
    ...
    /**
     * 密码强度计算 显示密码强度：纯字符或数字或符号为弱密码、包含数字、符号、英文字符为强密码、其余为中密码
     *
     * @create: 2014-8-19 上午11:27:12 miyb
     * @history:
     */
    public static String calculateSecurityLevel(String password) {
        ...
        for (char pwdChar : passwords) {
            ...
            // 小写字母 大写字母
            else if ((ascll >= 65 && ascll <= 90) || (ascll >= 97 && ascll <= 122)) {
                strength_M++;
